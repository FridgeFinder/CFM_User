...
```bash
user-service$ sam build --use-container
```
...
```bash
user-service$ pip install -r tests/requirements.txt --user
# unit test
user-service$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
user-service$ AWS_SAM_STACK_NAME="user-service" python -m pytest tests/integration -v
```
